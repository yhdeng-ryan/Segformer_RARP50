...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=dict(
            ...
            use_sigmoid=False,
            loss_weight=1.0,
            class_weight=[1.0, 1.4, 1.4, 1.13, 1.6, 2.1, 2.7, 1.2, 2.8,
                          1.16])),
    train_cfg=dict(),
...
data = dict(
    ...
    train=dict(
        ...
        data_root='/media/deep/Transcend/sar-rarp-dataset/',
        img_dir=[
            'traindata/video_1.zip/rgb', 'traindata/video_2.zip/rgb',
            'traindata/video_3.zip/rgb', 'traindata/video_4.zip/rgb',
            'traindata/video_6.zip/rgb', 'traindata/video_7.zip/rgb',
            'traindata/video_8.zip/rgb', 'traindata/video_9.zip/rgb',
            'traindata/video_10.zip/rgb', 'traindata/video_11_2.zip/rgb',
            'traindata/video_11.zip/rgb', 'traindata/video_13.zip/rgb',
            'traindata/video_15_1.zip/rgb', 'traindata/video_15_2.zip/rgb',
            'traindata/video_16.zip/rgb', 'traindata/video_17_1.zip/rgb',
            'traindata/video_17_2.zip/rgb', 'traindata/video_18.zip/rgb',
            'traindata/video_20.zip/rgb', 'traindata/video_21.zip/rgb',
            'traindata/video_22.zip/rgb', 'traindata/video_23.zip/rgb',
            'traindata/video_24.zip/rgb', 'traindata/video_25.zip/rgb',
            'traindata/video_26.zip/rgb', 'traindata/video_27.zip/rgb',
            'traindata/video_28.zip/rgb', 'traindata/video_29_2.zip/rgb',
            'traindata/video_30.zip/rgb', 'traindata/video_31.zip/rgb',
            'traindata/video_32.zip/rgb', 'traindata/video_33.zip/rgb',
            'traindata/video_34.zip/rgb', 'traindata/video_36.zip/rgb',
            'traindata/video_37.zip/rgb', 'traindata/video_38.zip/rgb',
            'traindata/video_39.zip/rgb', 'traindata/video_40.zip/rgb'
        ],
        ann_dir=[
            'traindata/video_1.zip/segmentation',
...
log_level = 'INFO'
load_from = 'pretrained/mit_b1.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = './work_dirs/segformer.b1.mit.80k.CW'
gpu_ids = range(0, 1)
