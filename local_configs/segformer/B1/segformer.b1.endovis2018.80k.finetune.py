...
model = dict(
    type='EncoderDecoder',
    pretrained='work_dirs/segformer.b1.endovis2018.40k/iter_40000.pth',
...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/segformer.b1.endovis2018.40k/iter_40000.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs/segformer.b1.endovis2018.80k.finetune'
gpu_ids = range(0, 1)
