...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/segformer.b1.mit.80k.CW/iter_80000.pth'
workflow = [('train', 1)]
...
lr_config = dict(
    ...
    min_lr=0.0,
    by_epoch=False)
runner = dict(type='IterBasedRunner', max_iters=82000)
checkpoint_config = dict(by_epoch=False, interval=500)
evaluation = dict(interval=500, metric='mIoU')
work_dir = './work_dirs/segformer.b1.mit.80k.CW.finetune'
gpu_ids = range(0, 1)
